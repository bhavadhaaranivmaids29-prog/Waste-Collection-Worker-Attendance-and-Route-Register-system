...
function seedData() {
  return {
    ...
    routes: [
      {id:"R001",name:"Route A - Main Street",assignedWorkerId:"W001",description:"Main Street, Park Road, Lake View, Temple Square",time:"13:00"},
      {id:"R002",name:"Route B - Industrial Area",assignedWorkerId:"W002",description:"Industrial Zone, Factory Road, Warehouse District",time:"16:00"},
      {id:"R003",name:"Route C - Residential Colony",assignedWorkerId:"W003",description:"Green Colony, Sunrise Nagar, Nehru Street",time:"13:00"},
      {id:"R004",name:"Route D - Market Area",assignedWorkerId:"W004",description:"Central Market, Bazaar Road, Flower Market, Fish Market",time:"11:00"},
      {id:"R005",name:"Route E - Highway Stretch",assignedWorkerId:"W005",description:"Highway Road, Toll Gate, Outskirts, Petrol Bunk Junction",time:"16:00"},
      {id:"R006",name:"Route F - Hospital Zone",assignedWorkerId:"W006",description:"Hospital Road, Clinic Street, Pharmacy Lane, Blood Bank Road",time:"15:00"},
      {id:"R007",name:"Route G - School District",assignedWorkerId:"W007",description:"School Road, College Lane, Library Street, Play Ground Road",time:"15:00"},
      {id:"R008",name:"Route H - Township",assignedWorkerId:"W008",description:"Township Layout, Sector 1-5, Community Hall Road, Park Avenue",time:"08:00"},
      {id:"R009",name:"Route I - Railway Colony",assignedWorkerId:"W009",description:"Railway Station Road, Platform Area, Colony Gate, Staff Quarters",time:"08:00"},
      {id:"R010",name:"Route J - Temple Town",assignedWorkerId:"W010",description:"Temple Street, Pilgrim Road, Ghat Road, Prasad Market",time:"10:30"},
      {id:"R011",name:"Route K - IT Park",assignedWorkerId:"W012",description:"IT Expressway, Tech Park, Software Layout, Cafeteria Road",time:"10:30"},
      {id:"R012",name:"Route L - Garden District",assignedWorkerId:"W014",description:"Botanical Garden Road, Rose Park, Lotus Lane, Fern Avenue",time:"08:00"},
      {id:"R013",name:"Route M - Lake View",assignedWorkerId:"W015",description:"Lakefront Road, Boat House Area, Fishermen Colony, Sunset Point",time:"14:00"},
      {id:"R014",name:"Route N - Shopping Complex",assignedWorkerId:"W016",description:"Mall Road, Hypermarket Lane, Food Court Street, Parking Area",time:"17:00"},
      {id:"R015",name:"Route O - Old City",assignedWorkerId:"W017",description:"Heritage Street, Fort Road, Ancient Bazaar, Clock Tower Area",time:"09:00"},
      {id:"R016",name:"Route P - University Campus",assignedWorkerId:"W018",description:"University Gate, Hostel Road, Sports Complex, Research Block",time:"10:00"},
      {id:"R017",name:"Route Q - Industrial Estate",assignedWorkerId:"W019",description:"Phase 1-3 Industrial Estate, Power House Road, Logistics Hub",time:"14:00"},
      {id:"R018",name:"Route R - Suburban Area",assignedWorkerId:"W021",description:"Suburban Bus Stand, Market Yard, School Zone, Residential Blocks A-D",time:"10:30"},
      {id:"R019",name:"Route S - Metro Colony",assignedWorkerId:"W024",description:"Metro Colony East, West Block, Community Park, Shopping Street",time:"11:00"},
      {id:"R020",name:"Route T - Green Valley",assignedWorkerId:"W025",description:"Green Valley Road, Hill View, Spring Lane, Water Tank Area",time:"09:30"},
      {id:"R021",name:"Route U - Bus Terminal",assignedWorkerId:"W026",description:"Central Bus Terminal, Auto Stand, Taxi Bay, Refreshment Corner",time:"18:00"},
      {id:"R022",name:"Route V - Power Station",assignedWorkerId:"W028",description:"Power Station Road, Transformer Colony, Grid Layout, Staff Quarters",time:"16:00"},
      {id:"R023",name:"Route W - Fishery Area",assignedWorkerId:"W029",description:"Harbor Road, Fish Market, Ice Plant Lane, Dock Yard",time:"08:00"},
      {id:"R024",name:"Route X - Medical Complex",assignedWorkerId:"W030",description:"Medical Complex Road, Specialist Clinic, Diagnostic Center, Ambulance Bay",time:"12:00"},
      {id:"R025",name:"Route Y - Craft Village",assignedWorkerId:"W031",description:"Artisan Colony, Handloom Lane, Pottery Street, Weaving Center",time:"07:00"},
      {id:"R026",name:"Route Z - Airport Road",assignedWorkerId:"W032",description:"Airport Approach Road, Hangar Area, Cargo Terminal, Radar Colony",time:"15:00"},
      {id:"R027",name:"Route AA - Civic Center",assignedWorkerId:"W033",description:"Municipal Office Road, Court Lane, Treasury Building, Post Office Street",time:"09:30"},
      {id:"R028",name:"Route AB - River Bank",assignedWorkerId:"W036",description:"Riverfront Promenade, Ghat Steps, Boat Jetty, Riverside Park",time:"14:00"},
      {id:"R029",name:"Route AC - Tech Hub",assignedWorkerId:"W037",description:"Startup Lane, Incubator Road, Co-working Street, Venture Park",time:"08:00"},
      {id:"R030",name:"Route AD - Heritage Zone",assignedWorkerId:"W038",description:"Museum Road, Gallery Lane, Statue Circle, Archaeological Site",time:"14:00"},
    ],
    attendance: [
